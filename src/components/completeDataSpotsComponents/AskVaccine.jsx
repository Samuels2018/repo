...
export default function AskVaccine () {
             ...
             <img src={logo} className="mr-3 sm:h-16 h-12 py-1 px-1" alt="Atletas Logo"></img>
                ...
                <div className="w-full h-full">
                    <div className="h-full w-full flex flex-col justify-center items-center">
                        <h3 className=" text-md text-[#00D3E0]">Paso 5 de 6</h3>
                        <h2 className="sm:text-3xl text-xl font-semibold text-white p-1 sm:py-3">Vacunado COVID?</h2>
                        ...
                        */}
                         <div
                            ...
                            >
                                 <Link
                                    to="/completeData/RegisterVaccine"
