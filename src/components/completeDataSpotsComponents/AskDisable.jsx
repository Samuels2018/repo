...
export default function AskDisable () {
             ...
             <img src={logo} className="mr-3 sm:h-16 h-12 py-1 px-1" alt="Atletas Logo"></img>
                ...
                <div className="w-full h-full">
                    <div className="h-full w-full flex flex-col justify-center items-center">
                        ...
                        <h2 className="sm:text-3xl text-xl font-semibold text-white p-1 sm:py-3">Posee algun tipo de discapacidad?</h2>
                            {/*
                         ...
                         <div
                            ...
                            >
                                <Link
                                    to="/completeData/RegisterInformation"
