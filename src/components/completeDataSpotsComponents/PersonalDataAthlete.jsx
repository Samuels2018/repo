...
export default function PersonalDataAthlete ({handleClick, currentStep, steps}) {
    ...
    const validationSchema = Yup.object().shape({
        id: Yup.string().required('la cedula es requerica')
                    ...
                    <div className="">
                        <div className="h-full w-full flex flex-col justify-center items-center">
                            ...
                            <div className="grid grid-cols-2 gap-x-2 gap-y-2 md:gap-x-4 md:gap-y-2 w-5/6 ">
                                <div className=" ">
                                    <label htmlFor="cedula" className="font-medium font-semibold block text-xs sm:text-sm text-white mb-1">Numero de Cedula de Identidad <mark className="bg-transparent text-red-600">*</mark></label>

                                    <Field 
                                        type="text" id="firstName" name="id"
                                        ...
                                        autoComplete="id" placeholder="ejemplo: 10747247" required 
                                    />
                                ...
                                <div className=" ">
                                    <label htmlFor="archivos" className="font-medium font-semibold block text-xs sm:text-sm text-white mb-1">Adjuntar la cedula de identidad </label>
