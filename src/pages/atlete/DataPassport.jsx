...
export default function DataPassport () {
    ...
    const validationSchema = Yup.object().shape({
        numberPassport: Yup.string().required('el numero del pasaporte es requerido')
    ...
    const handleSubmit = (valores) => {
        ...
        setTimeout(() => {
            if (athlete === 200 || athlete === 201) {
              setEnviar(false)
              setMessage(false)
              navigate('/completeData/MeasureAndSize')
                ...
                <Form className="w-full h-full">
                    <div className="">
                        <div className="h-full w-full flex flex-col justify-center items-center">
                            ...
                            <h2 className="sm:text-3xl text-xl font-semibold text-white p-1 sm:py-3">Datos Personales</h2>

                            <div className="grid grid-cols-2 gap-x-2 gap-y-2 md:gap-x-4 md:gap-y-2 w-5/6 ">
                                <div className=" ">
                                    <label htmlFor="pasaporte" className="font-medium font-semibold block text-xs sm:text-sm text-white mb-1">Numero de Pasaporte <mark className="bg-transparent text-red-600">*</mark></label>

                                    <Field 
                                        type="text" id="firstName" name="numberPassport"
                                        ...
                                        autoComplete="numberPassport" placeholder="ejemplo: 123456" required 
                                    />
                                ...
                                <div className=" ">
                                    <label htmlFor="facha de emision" className="font-medium font-semibold block text-xs sm:text-sm text-white mb-1">Fecha de Emision del Pasaporte <mark className="bg-transparent text-red-600">*</mark></label>

                                    <Field 
                                        type="date" id="" name="dateEmition"
                                        className=" transition-all w-full block py-2 px-0 w-full text-[11px] sm:text-sm 
                                        text-[#4E4B4B] rounded-lg icon-placeholder-user shadow-sm focus:outline-none 
                                        focus:shadow-outline font-semibold"
                                ...
                                <div className=" ">
                                    <label htmlFor="fecha de Vencimiento" className="font-medium font-semibold block text-xs sm:text-sm text-white mb-1">Fecha de Vencimiento del Pasaporte <mark className="bg-transparent text-red-600">*</mark></label>

                                    <Field 
                                        type="date" id="" name="dateExpire"
                                        className=" transition-all w-full block py-2 px-0 w-full text-[11px] sm:text-sm 
                                        text-[#4E4B4B] rounded-lg icon-placeholder-user shadow-sm focus:outline-none 
                                        focus:shadow-outline font-semibold"
                                ...
                                <div className=" ">
                                    <label htmlFor="secondName" className="font-medium font-semibold block text-xs sm:text-sm text-white mb-1">Adjuntar Pasaporte (Tamanio Y Formato por Definir)</label>
